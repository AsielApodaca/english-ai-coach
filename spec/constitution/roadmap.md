...
4. **101 · Frontend shell (cockpit + design system)** — rediseño total UI al layout de 3 zonas + dock (sidebar historial, stage central, top bar, settings overlay). Implementa `spec/design/design-system.md`. Elimina la tab "Free chat" del MVP. *(Zonas del stage en placeholders; contenido llega con 103/105/109.)*
